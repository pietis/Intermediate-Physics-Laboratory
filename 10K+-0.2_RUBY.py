...
# 5개의 Noise ASC 파일 경로
noise_paths = ["NOISEWITHOUTHAND/10K_NoiseWithoutHand1.asc",
...
# 5개의 파일 경로
data_paths = ["10K+-0.2_RUBY/10K_RUBY1.asc",
              "10K+-0.2_RUBY/10K_RUBY2.asc",
              "10K+-0.2_RUBY/10K_RUBY3.asc",
              "10K+-0.2_RUBY/10K_RUBY4.asc",
              "10K+-0.2_RUBY/10K_RUBY5.asc"]
...
# 최대 최소 찾기
xy_data = pd.DataFrame({'x coord': x_data, 'y coord': y_data})
print(xy_data)
