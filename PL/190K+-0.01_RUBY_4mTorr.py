...
# 5개의 Noise ASC 파일 경로
noise_paths = ["PL/Data/190K+-0.01_RUBY_4mTorr/190K_RUBY_NOISE%d.asc"%(i) for i in range(1,6)]
...
# 5개의 파일 경로
data_paths = ["PL/Data/190K+-0.01_RUBY_4mTorr/190K_RUBY_%d.asc"%(i) for i in range(1,6)]
...
initial_guess = [15000, 1.7898644299684574, 0.00018940549781398808, 0.00018940549781398808, 
                 6000, 1.7936623131076712, 0.000037036715120915, 0.000037036715120915] 
