...
# 5개의 Noise ASC 파일 경로
noise_paths = ["PL/Data/NOISEWITHHANDOF670AREA/10K_NoiseWithHand%d.asc"%(i) for i in range(1,6)]
...
# 5개의 파일 경로
data_paths = ["PL/Data/NOISEWITHOUTHAND/10K_NoiseWithoutHand%d.asc"%(i) for i in range(1,6)]
...
initial_guess = [25000, 1.7898644299684574, 0.00018940549781398808, 0.00018940549781398808, 
                 8000, 1.7936623131076712, 0.000037036715120915, 0.000037036715120915] 
...
plt.plot(x_data, y_fit, 'r--', label = 'Voigt fitting')
