...
# 5개의 Noise ASC 파일 경로
noise_paths = ["PL/Data/NOISEWITHOUTHAND/10K_NoiseWithoutHand%d.asc"%(i) for i in range(1,6)]
...
# 5개의 파일 경로
data_paths = ["PL/Data/10K+-0.2_RUBY/10K_RUBY%d.asc"%(i) for i in range(1,6)]
