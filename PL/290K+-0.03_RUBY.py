...
# 5개의 Noise ASC 파일 경로
noise_paths = ["PL/Data/290K+-0.03_RUBY_46mTorr/290K_RUBY_NOISE%d.asc"%(i) for i in range(1,6)]
...
# 5개의 파일 경로
data_paths = ["PL/Data/290K+-0.03_RUBY_46mTorr/290K_RUBY_%d.asc"%(i) for i in range(1,6)]
...
initial_guess = [2800, 1.7888644299684574, 0.00018940549781398808, 0.00018940549781398808, 
                 2200, 1.79236623131076712, 0.000037036715120915, 0.000037036715120915] 
# fitting이 잘 안되면 열심히 조절할 것

voigt_func, pcov = curve_fit(voigt, x_data, y_data, p0 = initial_guess, maxfev=30000)
